        ...
        {({ open }) => {
          ...
          return (
            <>
              ...
              <Popover.Panel className="w-[314px] sm:w-[177px] pb-[66px] pt-[45px] pr-[104px] pl-8 sm:p-6 sm:pb-4 sm:pt-2 sm:pr-2 flex flex-col gap-4 sm:gap-x-8 sm:gap-y-1 sm:rounded-sm border border-mono-400 bg-mono-100 shadow-light top-16 sm:top-12 absolute z-10 right-0">
                <Link href={`/`}>
                  <div
                    role="button"
                    className=" sm:mt-2 text-left bg-dark-background font-bold text-white w-full text-xs rounded flex items-center space-x-[12px] h-full min-h-14 sm:min-h-12 sm:hover:opacity-80"
                  >
                    <span>📦</span>
                    <span>Home</span>
                  </div>
                ...
                {connected && (
                  <Link href={`/profile/${props.account.address}`}>
                    <div
                      role="button"
                      className=" sm:mt-2 bg-dark-background font-bold text-white w-full text-xs text-left rounded flex h-full items-center space-x-[12px] min-h-14 sm:min-h-12 sm:hover:opacity-80"
                    >
                      <span>🤡</span>
                      <span>Profile</span>
                    </div>
                ...
                <Link
                  ...
                  className=" sm:mt-2 bg-dark-background font-bold text-white w-full text-xs text-left rounded flex items-center h-full space-x-[12px] min-h-14 sm:min-h-12 sm:hover:opacity-80"
                  target="_blank"
                ...
                <div className="flex gap-12 sm:gap-4 mt-5">
                  <Image
                    width={24}
                    height={24}
                    src={TwitterIcon}
