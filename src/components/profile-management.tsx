...
export const ProfileManagment = (props: { account: UserContextType; disconnect: () => Promise<void> }) => {
  return (
    <div className="h-10 min-w-[137px] flex items-center justify-evenly bg-inherit border border-primary-100 rounded-sm">
      ...
      <div className="w-2/9 h-10 box-content focus-visible:outline-none">
