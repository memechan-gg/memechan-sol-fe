...
const Disclaimer = ({ headerText, bodyText, onClick }: DisclaimerProps) => {
  return (
    <div className="rounded-tl-[2px] border-[1px] border-solid border-monochrome-400">
      <div className=" bg-monochrome-400 p-[5px] pl-[15px] pr-[15px] flex justify-between items-center">
