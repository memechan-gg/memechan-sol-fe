...
export const Button = ({
  ...
  const buttonStyles: ButtonVariantMap = {
    ...
    disabled: `w-full h-full rounded-sm  justify-center cursor-not-allowed ${theme === "light" ? "disabled:text-mono-200 text-mono-200 disabled:bg-mono-500 bg-mono-500" : "bg-mono-400"}'`,
  };
