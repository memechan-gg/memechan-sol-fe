...
export const Button = ({
  ...
  const buttonStyles: ButtonVariantMap = {
    primary:
      "flex items-center text-white h-10 w-full bg-primary-100 justify-center text-xs leading-5 font-bold text-mono-600 p-2 pl-4 pr-4 rounded-sm hover:bg-primary-300 active:bg-primary-400 focus:outline-none",
    secondary:
      "bg-mono-100 cursor-pointer h-10 w-full text-center justify-center border border-primary-100 rounded items-center text-xs justify-center flex flex-row gap-2 font-bold text-regular hover:bg-primary-200 active:bg-primary-300 focus:outline-none",
    regular:
